...
public class LostCall extends JFrame {
    ...
    public LostCall() {
        super("Lost Call Simulation System");
        ...
        engine = new TelephoneEngine(false);   // false = Lost Call mode
    ...
    /** Full width, below everything else (x = 20-860, y = 370-460): the four running totals. */
    private void buildCountersPanel() {
        JPanel panel = titledPanel("CALL COUNTERS", 20, 370, 840, 90);
    ...
    private void buildButtonsAndLog() {
        ...
        nextEventButton.setBounds(20, 470, 150, 38);
        ...
        autoButton.setBounds(180, 470, 150, 38);
        ...
        restartButton.setBounds(340, 470, 150, 38);
        restartButton.addActionListener(e -> {
            ...
            engine = new TelephoneEngine(false);
            logArea.setText("");
        ...
        scroll.setBounds(20, 520, 840, 260);
        add(scroll);
    }

    // ================================================================
    //  REFRESHING THE SCREEN FROM engine's CURRENT STATE
    // ================================================================
